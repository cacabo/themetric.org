...
export const FACEBOOK_PAGE_LINK = (username: string): string =>
  `https://www.facebook.com/${username}`
export const FACEBOOK_LINK = FACEBOOK_PAGE_LINK('TheMetricGlobal')

export const TWITTER_PAGE_LINK = (username: string): string =>
  `https://www.twitter.com/${username}`
export const TWITTER_LINK = TWITTER_PAGE_LINK('TheMetric_')
